...
import { 
  ...
  HelpCircle as HelpIcon, ArrowRight, Laptop, Server, RefreshCw
} from 'lucide-react';
              ...
              <div className="bg-white border border-slate-200 rounded shadow-2xs overflow-hidden">
                ...
                <div className="overflow-x-auto select-text">
                  <table className="min-w-full divide-y divide-slate-200 text-left text-xs text-slate-700">
                    <thead className="bg-[#f0f4f8] text-[10px] font-bold uppercase text-slate-[#0a304e] tracking-wider">
                      <tr>
      ...
      {isNotesModalOpen && (
        <div id="notes-modal" className="fixed inset-0 bg-[#000000]/65 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg border border-slate-350 shadow-2xl max-w-md w-full overflow-hidden text-slate-800">
            ...
            <div className="bg-slate-105 px-5 py-3.5 border-t border-slate-200 flex justify-end gap-2 shrink-0">
              <button 
                type="button"
                onClick={() => setIsNotesModalOpen(false)}
